...
export const ContactSection = ({id}:{id:string}) => {
  const handleContactClick = () => {
    // Email details
    const email = 'wuhsinyen0915@gmail.com';
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-center">
            ...
            <div>
              <button 
                ...
                className="text-white bg-gray-900 inline-flex items-center px-6 h-12 rounded-xl gap-2 w-max border border-gray-900 hover:bg-gray-800 transition-colors duration-300"
